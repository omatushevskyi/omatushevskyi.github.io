...
captcha_html += '<iframe id="doom_captcha" src="https://omatushevskyi.github.io/captcha.html?version=' + captcha_version + '&countdown=' + document.currentScript.getAttribute('countdown') + '&enemies=' + captcha_enemies + '" style="width:300px;height:150px;border:2px black solid;"></iframe>';
...
window.addEventListener('message', function(e) {
    if (e.origin.indexOf('omatushevskyi.github.io') > -1) {
        captcha_done = true;
